...
public class S3Reader extends Reader {
    ...
    public static class Task extends Reader.Task {
        ...
        public void startRead(RecordSender recordSender) {
            ...
            AmazonS3 s3Client = S3ClientUtil.initOssClient(readerSliceConfig);
            String bucket = readerSliceConfig.getString(Key.BUCKET);

            S3Object inputStream = S3ClientUtil.getObject(s3Client, bucket, object);
            UnstructuredStorageReaderUtil.readFromStream(inputStream.getObjectContent(), object,
